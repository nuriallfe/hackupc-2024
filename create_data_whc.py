...
class CreateDataLandmarks:
	...
	def get_data_landmarks(self):
		...
		"""
		df = pd.read_csv(self.landmarks_file)
		landmarks = df['name_en'].tolist()
		return landmarks
	...
	def get_coordinates(self):
		...
		coordinates['latitude'] = df['latitude']
		coordinates['longitude'] = df["longitude"]
		return coordinates
	...
	def save_dataset(self):
		...
		self.df.to_csv(f"{self.save_dir}/data_wh.csv", index=False)
